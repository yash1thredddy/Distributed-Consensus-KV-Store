...
// AppendEntries RPC - used by leader for replication and heartbeats
...
type AppendEntriesResponse struct {
	...
	ConflictTerm  int64                  `protobuf:"varint,5,opt,name=conflict_term,json=conflictTerm,proto3" json:"conflict_term,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_api_proto_raft_proto_rawDesc = "" +
	"\n" +
	"\x14api/proto/raft.proto\x12\x06raftpb\"N\n" +
	"\bLogEntry\x12\x12\n" +
	...
	"\rleader_commit\x18\x06 \x01(\x03R\fleaderCommit\"\xb2\x01\n" +
	"\x15AppendEntriesResponse\x12\x12\n" +
	"\x04term\x18\x01 \x01(\x03R\x04term\x12\x18\n" +
	"\asuccess\x18\x02 \x01(\bR\asuccess\x12\x1f\n" +
	"\vmatch_index\x18\x03 \x01(\x03R\n" +
	"matchIndex\x12%\n" +
	"\x0econflict_index\x18\x04 \x01(\x03R\rconflictIndex\x12#\n" +
	"\rconflict_term\x18\x05 \x01(\x03R\fconflictTerm\"\xbb\x01\n" +
...
var file_api_proto_raft_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
